...
function malePopNumbers(data){
  var output = [];

  data.map(function(pops){
    output.push(pops.males);
  });
  return output;
}
result = malePopNumbers(dataset);
// console.log("male pop numbers",result);
...
function popsByAge(data){
  var output = data.map(function(pop){
    var obj = {
      age: pop.age,
      males: pop.males,
      females: pop.females
...
result = popsByAge(dataset);
// console.log("Gendered Population by Age : \n",result);
...
function popDataWithDifference(data){
  ...
  var output = data.map(function(pop){
    var obj = {
      ...
      females:pop.females,
      males:pop.males,
      diffrerence:(pop.males-pop.females)
    }
    return obj;
  });
